...
function onFileChoose(event){var target=event.currentTarget||event.srcElement;window.setLink(target.getAttribute("data-file"),target.getAttribute("data-is-image"));}
