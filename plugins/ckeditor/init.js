/*
 * @version $Id: init.js 248 2017-04-28 14:29:03Z hi $
 *
 */
...
CKEDITOR.on('instanceCreated', function (event) {
    if (window.addEventListener) {
        event.editor.element.$.form.addEventListener("submit", function () {
            event.editor.resetDirty();
        }, false);
    }
    else {
        event.editor.element.$.form.attachEvent("submit", function () {
            event.editor.resetDirty();
        }, false);
    }
